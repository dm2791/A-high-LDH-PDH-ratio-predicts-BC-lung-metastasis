...
hexokinase_50min=readmatrix('hexokinasedatamat.csv');
standard=[];
j=1;
for i=3:8
...
pfk_5min=readmatrix('pfkdatamat.csv');
standard=[];
j=1;
for i=3:8
...
g3pdh_0min=readmatrix('g3pdhdatamat.csv');
standard=[];
j=1;
for i=3:8
...
pk_fl0min=readmatrix('pkdatamat.csv');
standard=[];
j=1;
for i=3:8
